(function(window, createjs, opspark, _) {
  ...
  createjs.Sound.alternateExtensions = ["mp3"]; //does lines 12-14 make sound effects everytime the paddle and balls hit something?
  ...
  const
    ...
    paddleCPU = createPaddle({ x: canvas.width - 34, y: canvas.height - 100 }),
  ...
  function update(event) {
    const
      ...
      midCPU = heightCPU / 2,
      boundsPlayer = paddlePlayer.getBounds(), //what does the getBounds function do?

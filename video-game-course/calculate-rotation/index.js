...
(function (window, createjs, opspark, gummybears) {
  ...
  function update(event) {
    ...
    const degrees = gummybears.numz.getAngleDegrees(ship, mouse);
...
(window, window.createjs, window.opspark, window.gummybears);
